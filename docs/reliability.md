...
- RX sensitivity (SF10, BW62.5, boosted gain): **~-134 dBm** (datasheet; the
...
Link margin    = -107 - (-134) = ~27 dB at 10 km (datasheet floor)
```

**~27 dB of headroom** at 10 km on paper covers typical fading (10-20 dB);
